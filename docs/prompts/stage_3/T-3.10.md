...
> | Wave | 7（实测期；跨多日多次会话）|
> | 依赖 | T-3.5 + T-3.6a + T-3.6b + T-3.4 全部 PR merge **+ T-3X-1（ADR-030 + schema + prompt hook）PR merge + T-3X-0（AESTHETIC_PREFERENCES.md v0.1）已 commit**（2026-05-09 v0.2 新增）|
...
- /docs/AESTHETIC_PREFERENCES.md（2026-05-09 v0.2 新增；T-3X-0 产出；审美锚点字段集源 — T-3.10 运行前必须 v0.1 已 commit）
- /docs/DECISIONS.md ADR-030（AestheticPreference schema）+ ADR-020 v0.2（PR-A 已落地；阶段 2/3/4 三阶段 [A] gate 口径）
- /docs/reviews/master_plan/2026-05-09_aesthetic_layer_decision_v0.1.md v0.2 §6.2（审美层决策 v0.2；T-3X-0/1 前置工作流）
